...
const SalesByHour = lazy(() => import("@/components/Charts/SalesByHour"));
const SalesByDay = lazy(() => import("@/components/Charts/SalesByDay"));
...
const StatsLoader = () => {
  ...
  if (result.status === "success") {
    ...
    hourSales = (
      <Suspense fallback={<SalesByHourSkeleton />}>
        <SalesByHour hours={result.data.hours} />
      </Suspense>
    );
    daySales = (
      <Suspense fallback={<SalesByDaySkeleton />}>
        <SalesByDay days={days} />
      </Suspense>
    );
  }
  return (
